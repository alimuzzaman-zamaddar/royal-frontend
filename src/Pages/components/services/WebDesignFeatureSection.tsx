  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1480px]">
        ...
        >
          <div className="flex h-[48px] w-[48px] items-center justify-center rounded-full border border-[#4ADE80] text-[#4ADE80] transition-all duration-300 hover:scale-110 hover:shadow-[0_0_24px_rgba(74,222,128,0.35)]">
        ...
        {/* Content Box */}
        <div
          className={`rounded-3xl border border-[#4ADE80]/40 px-4 py-4 transition-all duration-[900ms] ease-[cubic-bezier(0.22,1,0.36,1)] sm:px-5 sm:py-5 md:px-6 md:py-6 ${revealClass}`}
          style={{
