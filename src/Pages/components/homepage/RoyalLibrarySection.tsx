  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1480px]">
        <h2
          className={`mb-4 text-[#ffffff] flex items-center gap-3 justify-center font-cinzel text-[24px]  leading-[120%] transition-all duration-[850ms] ease-[cubic-bezier(0.22,1,0.36,1)] sm:text-5xl lg:text-6xl ${revealClass}`}
          style={{
